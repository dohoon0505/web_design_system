...
const SCU_BASE_CSS = ''
  ...
  + '.scu-inner { width: 100%; max-width: 1100px; display: grid; grid-template-columns: 1fr 1fr; gap: 40px; padding: 48px 44px; background: #fff; border-radius: 32px; box-shadow: 0 24px 64px -16px rgba(0,0,0,0.10), 0 0 0 1px rgba(0,0,0,0.06); font-family: "Pretendard Variable","Pretendard",sans-serif; }\n'
